...
docente_model = docente_ns.model('Docente',{
    ...
    'observações':fields.String(required=True,description='Observações sobre o docente')
})
...
docente_output_model = docente_ns.model('DocenteOutput',{
    ...
    'observações':fields.String(description='Observações sobre o docente')
})
...
class DocenteResource(Resource):
    ...
    def DeleteAllDocentes():
        return limpar_docentes()
